    ...
    <IonReactRouter>
      <IonTabs>
        <IonRouterOutlet>
          ...
          <Route exact path="/ion-t-dapaton/calculator">
            <Calculator />
          </Route>
          <Route exact path="/ion-t-dapaton/todolist">
            <Todolist />
          </Route>
          <Route exact path="/ion-t-dapaton/quotesgenerator">
            <QuotesGenerator />
          </Route>
          <Route exact path="/ion-t-dapaton/notes">
            <Notes />
          </Route>
        ...
        <IonTabBar slot="bottom">
          ...
          <IonTabButton tab="home" href="/ion-t-dapaton/home">
          ...
          */}
          ...
          <IonTabButton tab="profile" href="/ion-t-dapaton/profile">
            <IonIcon aria-hidden="true" icon={personCircleOutline} />
            <IonLabel>Profile</IonLabel>
          </IonTabButton>
